...
CREATE TABLE `habit` (
  ...
  `type` int DEFAULT NULL COMMENT '习惯周期类型',
  `target_count` int DEFAULT '1' COMMENT '周期次数',
...
-- ----------------------------
-- Table structure for habit_record
-- ----------------------------
...
CREATE TABLE `habit_record` (
  ...
  `record_date` datetime DEFAULT NULL COMMENT '记录日期（xxxx-xx-xx）',
  `count` int DEFAULT '0' COMMENT '记录次数',
  `status` int DEFAULT '0' COMMENT '状态（0未打卡，1打卡）',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='习惯打卡记录表';
...
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (4, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', 'c1ddd8870b77405a823918661d5d7a2f', '超级管理员', 'password', 'Chrome 145', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-03-05 09:26:29');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (5, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '5da444a2b6d749a8b21bef2a0c6b13c5', '超级管理员', 'password', 'Chrome 145', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-03-05 09:27:49');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (6, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '7d71865ec8c640d59d37054080380a87', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-04-10 10:43:42');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (7, 3, 'user1', '钧逸用户1', '127.0.0.1', '内网IP', '2fba862a881249529248f138dc83dad3', '普通用户', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-04-10 10:52:07');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (8, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '10e3ef4f6c6b4fc0986bd8474aa7fa05', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-04-10 13:43:19');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (9, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '5fa2142a37454977a27ca381dfcfdeea', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-07 04:47:01');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (10, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '3367eabeb6094645a61ff35799ff3d8d', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-07 05:05:20');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (11, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', 'd00f38cd82d94df5b3a2d274189a1911', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-09 23:13:39');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (12, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '9225666dc9134567a40772efd5934e74', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-09 23:14:23');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (13, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '197f1fdd655d4ce4a29ea100539bc0cb', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-15 10:32:26');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (14, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '896d62c882f8408d8269692c22efc890', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-28 23:42:39');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (15, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', 'cce11198017c43df9e0cab4e138b039a', '超级管理员', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-28 23:46:01');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (16, 2, 'admin', '用户管理员', '127.0.0.1', '内网IP', '6b5e552c3698440c8d19481508b95b64', '普通用户', 'password', 'Chrome 146', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-05-28 23:46:51');
INSERT INTO `sys_auth_log` (`id`, `user_id`, `user_name`, `nick_name`, `login_ip`, `ip_region`, `session_id`, `identity`, `login_type`, `browser`, `os`, `device_type`, `status`, `msg`, `login_time`) VALUES (17, 1, 'super_admin', '超级管理员', '127.0.0.1', '内网IP', '2b1601df218a4ff18048eb981105d40d', '超级管理员', 'password', 'Chrome 149', 'macOS 10.15.7', 'Desktop', 1, '登录成功', '2026-06-28 20:18:02');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_config` (`config_id`, `config_key`, `config_value`, `config_name`, `config_type`, `sort`, `is_system`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 'sys.system.name', '我们的生活', '系统名称', 'text', 1, 1, 0, 'system', '2026-01-28 22:04:26', 'super_admin', '2026-06-28 20:19:12', '系统显示名称');
...
INSERT INTO `sys_config` (`config_id`, `config_key`, `config_value`, `config_name`, `config_type`, `sort`, `is_system`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (4, 'sys.system.copyright', 'EatFan', '版权所有者', 'text', 4, 1, 0, 'system', '2026-01-28 22:04:29', 'super_admin', '2026-06-28 20:19:23', '版权所有者名称');
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `title`, `icon`, `menu_type`, `sort`, `permission`, `is_hide`, `is_hide_tab`, `keep_alive`, `is_iframe`, `link`, `is_full_page`, `fixed_tab`, `active_path`, `show_badge`, `show_text_badge`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (125, 0, 'Habit', '/habit', '/index/index', '习惯管理', 'ri:evernote-line', 0, 2, '', 0, 0, 1, 0, '', 0, 0, '', 0, '', 1, NULL, '2026-06-28 21:08:33', 'super_admin', '2026-06-28 21:10:43', '');
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `title`, `icon`, `menu_type`, `sort`, `permission`, `is_hide`, `is_hide_tab`, `keep_alive`, `is_iframe`, `link`, `is_full_page`, `fixed_tab`, `active_path`, `show_badge`, `show_text_badge`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (126, 125, 'HabitList', 'list', '/habit/list', '习惯列表', 'ri:list-ordered', 1, 1, 'habit.ui.list.view', 0, 0, 1, 0, '', 0, 0, '', 0, '', 1, NULL, '2026-06-28 21:09:16', 'super_admin', '2026-06-28 21:10:43', '');
COMMIT;
...
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (3, 'info', 'update', 'menu', 1, 'super_admin', '超级管理员', '更新了菜单「menus.plan.log」', '50', 'menus.plan.log', '/system/menu', 'PUT', '127.0.0.1', NULL, '2026-05-15 10:32:46');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (4, 'info', 'update', 'perm_group', 1, 'super_admin', '超级管理员', '更新了权限组「默认用户权限组」', '1', '默认用户权限组', '/system/permission', 'PUT', '127.0.0.1', '{\"id\":1,\"groupCode\":\"default_user\",\"groupName\":\"默认用户权限组\",\"priority\":10,\"description\":\"系统所有登录用户的基础权限\",\"status\":1,\"permissions\":[\"system.api.dict.get.all\"]}', '2026-05-28 23:55:44');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (5, 'info', 'update', 'perm_group', 1, 'super_admin', '超级管理员', '更新了权限组「默认管理权限组」', '2', '默认管理权限组', '/system/permission', 'PUT', '127.0.0.1', '{\"id\":2,\"groupCode\":\"default_admin\",\"groupName\":\"默认管理权限组\",\"priority\":100,\"description\":\"系统所有管理用户的基础权限\",\"status\":1,\"permissions\":[\"system.ui.user.button.dept\",\"system.ui.auth-log.view\",\"system.ui.oper-log.view\",\"system.ui.menu.button.edit\",\"system.ui.dict.view\",\"system.ui.menu.button.add\",\"system.ui.session.button.logout\",\"system.ui.auth-log.button.delete\",\"system.ui.role.button.permission\",\"system.ui.dict.button.add\",\"system.ui.permission.pool.view\",\"system.ui.user.button.permission\",\"system.ui.config.button.edit\",\"system.ui.role.button.edit\",\"system.ui.oper-log.button.clear\",\"system.ui.user.button.role\",\"system.api.dict.get.all\",\"system.ui.dict.button.edit\",\"system.ui.dept.view\",\"system.ui.info.view\",\"system.ui.permission.button.delete\",\"system.ui.menu.view\",\"system.ui.permission.pool.button.delete\",\"system.ui.cache.button.detail\",\"system.ui.user.button.edit\",\"system.ui.user.view\",\"system.ui.permission.pool.button.add\",\"system.ui.permission.view\",\"system.ui.permission.button.edit\",\"system.ui.auth-log.button.clear\",\"system.ui.cache.button.clear\",\"system.ui.config.view\",\"system.ui.dept.button.permission\",\"system.ui.role.view\",\"system.ui.session.view\",\"system.ui.dept.button.add\",\"system.ui.cache.view\",\"system.ui.config.button.delete\",\"system.ui.config.button.add\",\"system.ui.user.button.individual-perm\",\"system.ui.role.button.delete\",\"system.ui.dept.button.edit\",\"system.ui.cache.button.delete\",\"system.ui.dict.button.delete\",\"system.ui.dept.button.delete\",\"system.ui.permission.button.add\",\"system.ui.user.button.delete\",\"system.ui.user.button.add\",\"system.ui.menu.button.delete\",\"system.ui.role.button.add\",\"system.ui.oper-log.button.delete\",\"system.ui.permission-pool.button.status\"]}', '2026-05-28 23:55:50');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (6, 'info', 'update', 'menu', 1, 'super_admin', '超级管理员', '更新了菜单「menus.plan.log」', '50', 'menus.plan.log', '/system/menu', 'PUT', '127.0.0.1', NULL, '2026-05-28 23:56:11');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (7, 'info', 'delete', 'menu', 1, 'super_admin', '超级管理员', '删除了菜单「menus.document.title」', '49', 'menus.document.title', '/system/menu/49', 'DELETE', '127.0.0.1', NULL, '2026-06-28 20:18:26');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (8, 'info', 'delete', 'menu', 1, 'super_admin', '超级管理员', '删除了菜单「menus.plan.log」', '50', 'menus.plan.log', '/system/menu/50', 'DELETE', '127.0.0.1', NULL, '2026-06-28 20:18:29');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (9, 'info', 'update', 'menu', 1, 'super_admin', '超级管理员', '更新了菜单「menus.dashboard.ecommerce」', '4', 'menus.dashboard.ecommerce', '/system/menu', 'PUT', '127.0.0.1', NULL, '2026-06-28 20:18:37');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (10, 'info', 'update', 'menu', 1, 'super_admin', '超级管理员', '更新了菜单「menus.dashboard.analysis」', '3', 'menus.dashboard.analysis', '/system/menu', 'PUT', '127.0.0.1', NULL, '2026-06-28 20:18:42');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (11, 'info', 'delete', 'menu', 1, 'super_admin', '超级管理员', '删除了菜单「menus.operation.api-doc」', '111', 'menus.operation.api-doc', '/system/menu/111', 'DELETE', '127.0.0.1', NULL, '2026-06-28 20:18:49');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (12, 'info', 'delete', 'menu', 1, 'super_admin', '超级管理员', '删除了菜单「menus.operation.generate」', '96', 'menus.operation.generate', '/system/menu/96', 'DELETE', '127.0.0.1', NULL, '2026-06-28 20:18:51');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (13, 'info', 'delete', 'menu', 1, 'super_admin', '超级管理员', '删除了菜单「menus.operation.title」', '95', 'menus.operation.title', '/system/menu/95', 'DELETE', '127.0.0.1', NULL, '2026-06-28 20:18:53');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (14, 'info', 'create', 'menu', 1, 'super_admin', '超级管理员', '创建了菜单「习惯管理」', '125', '习惯管理', '/system/menu', 'POST', '127.0.0.1', NULL, '2026-06-28 21:08:33');
INSERT INTO `sys_oper_log` (`id`, `level`, `action`, `module`, `user_id`, `user_name`, `nick_name`, `message`, `target_id`, `target_name`, `path`, `method`, `ip`, `raw_data`, `create_time`) VALUES (15, 'info', 'create', 'menu', 1, 'super_admin', '超级管理员', '创建了菜单「习惯列表」', '126', '习惯列表', '/system/menu', 'POST', '127.0.0.1', NULL, '2026-06-28 21:09:16');
COMMIT;
...
INSERT INTO `sys_user` (`user_id`, `user_name`, `nick_name`, `avatar`, `email`, `phonenumber`, `sex`, `password`, `salt`, `status`, `del_flag`, `pwd_update_time`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (8, 'mp_opoNY1_B', '微信用户', NULL, NULL, NULL, '0', NULL, NULL, 1, 0, NULL, 'system', '2026-05-15 08:12:41', NULL, NULL, NULL);
INSERT INTO `sys_user` (`user_id`, `user_name`, `nick_name`, `avatar`, `email`, `phonenumber`, `sex`, `password`, `salt`, `status`, `del_flag`, `pwd_update_time`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (9, 'mp_o9ztm3Rr', '微信用户', NULL, NULL, NULL, '0', NULL, NULL, 1, 0, NULL, 'system', '2026-05-15 08:46:40', NULL, NULL, NULL);
INSERT INTO `sys_user` (`user_id`, `user_name`, `nick_name`, `avatar`, `email`, `phonenumber`, `sex`, `password`, `salt`, `status`, `del_flag`, `pwd_update_time`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (10, 'mp_oG0xp3bL', '微信用户', NULL, NULL, NULL, '0', NULL, NULL, 1, 0, NULL, 'system', '2026-06-28 20:40:26', NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色数据关联表';
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES (34, 2, 2);
COMMIT;
...
CREATE TABLE `sys_user_third_auth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户第三登录绑定表';

-- ----------------------------
-- Records of sys_user_third_auth
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_third_auth` (`id`, `user_id`, `auth_type`, `auth_key`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 8, 'wechat_mp', 'opoNY1_BVXKhLuV3Wv2012czYMD8', NULL, '2026-05-15 08:12:41', NULL, '2026-05-15 08:12:41', NULL);
INSERT INTO `sys_user_third_auth` (`id`, `user_id`, `auth_type`, `auth_key`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, 9, 'wechat_mp', 'o9ztm3RrTmye26KKPMq7804t-TNI', NULL, '2026-05-15 08:46:40', NULL, '2026-05-15 08:46:40', NULL);
INSERT INTO `sys_user_third_auth` (`id`, `user_id`, `auth_type`, `auth_key`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (3, 10, 'wechat_mp', 'oG0xp3bLok2huOjF6ybD_91AEMew', NULL, '2026-06-28 20:40:26', NULL, '2026-06-28 20:40:26', NULL);
COMMIT;
